...
const GreenDot = () => (
  <span className="rounded-full text-green-500 text-3xl mx-4">•</span>
);
    ...
    <>
      <footer className="bg-black relative ">
        ...
        <div className="absolute right-4 xs:right-6 sm:right-8 bottom-6 md:bottom-8 cursor-pointer">
          <button
            onClick={scrollToTop}
            className="text-black text-base font-semibold bg-green-500 px-8 py-[10px] md:px-10 md:py-[12px] rounded-full inline-flex items-center justify-center border border-transparent hover:bg-transparent hover:border-green-500 hover:text-green-500 transition-all duration-200"
          >
